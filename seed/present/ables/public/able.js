...
//
// public/able.js — the "commons" delegate.
//
// Per seed/AblesAreAuth.md "Public being": every story ships a
...
// can't grant, can't revoke, can't author ables. That silence IS the
...
export const publicAble = Object.freeze({
  name: "public",
  description:
  ...
  // Empty can. public CANNOT see/do/summon/be anything. The able's
