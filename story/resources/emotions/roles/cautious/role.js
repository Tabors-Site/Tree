// emotions:cautious — modifier role spec.
//
...
export const cautiousRole = Object.freeze({
  name: "cautious",
  description: `Modifier role: stacks onto a primary role to shape voice as "cautious".`,
  can: [],
