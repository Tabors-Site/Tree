// store:publisher. The public able a being picks up to publish.
//
// Publishing requires an IDENTIFIED being, not an anonymous wire poke
// (philosophy/OS/ROOTS.md). The able attaches to a KEY, and how that
// key is PRESENT to the store is orthogonal to the able:
//
...
//     identity. It never moves; its key is simply granted the able here.
//     (The do:mate being-child is a further variant: a foreign story
//     fathers a being here and acts through it.)
//
// The able does not care which. Whoever holds it, identified by key, may
...
//
// An open store makes this able self-grantable (any identified being
// may take it); a curated store gates the grant behind operator review.
// Same able, one knob: who is allowed to hold it.
//
// The able grants only the REACH to summon the registrar. It writes
...
// protect the catalog. So this able is safe to hand out widely.

export const publisherAble = Object.freeze({
  ...
  // a scripted being, or a human all hold this able the same way.
