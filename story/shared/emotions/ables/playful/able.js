// emotions:playful — modifier able spec.
//
...
export const playfulAble = Object.freeze({
  name: "playful",
  description: `Modifier able: stacks onto a primary able to shape voice as "playful".`,
  can: [],
