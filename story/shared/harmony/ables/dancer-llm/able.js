...
//
// Pure able spec. The seed's able registry auto-wraps defaultSummon
// for ables without a custom summon function . defaultSummon calls
...
export const dancerLlmAble = Object.freeze({
  name: "dancer-llm",
  ...
  // Declared capabilities. The `can` list is the able's preloaded
  ...
  // No toolNames field. The able spec IS its `can` list.
  can: [
  ...
  // plant time. One able template, N personas at runtime.
  prompt(ctx) {
