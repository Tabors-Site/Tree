...
| ------------------ | ------------------------------------------------------------- | ----------------- | ------------------------------------------------------------- |
| **I-Am**           | (bootstrap — bypasses able-walk via `identity.beingId === I`) | —                 | **No grants needed.** The I-Am bypass is the bootstrap axiom. |
...
```
1. I-Am bypass — if identity.beingId === I, allow (no able-walk).
