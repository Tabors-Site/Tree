...
const flow = parse(readFileSync(new URL("../../store/words/cherub/cherub.word", import.meta.url), "utf8"))[0];
...
const allThrough = (flow.effects || []).every((e) => e.by === "I" && e.through === "Cherub");
