...
export const federationManagerAble = Object.freeze({
  name: "federation-manager",
  description:
    "Negotiates subtree exchange with peer realities. Operator triggers offer-template or request-template DO ops; the able handles incoming offer-template / request-template / deliver-template SUMMONs from peer realities.",
