...
//
// The merge-mediator able is the UX layer over that pipeline. The
...
export const mergeMediatorAble = Object.freeze({
  name: "merge-mediator",
  description:
...
`,
  ...
  async call(_message, _ctx) {
    // LLM-cognition able: the seed factory builds the moment, runTurn
