...
//
// llm-assigner able. The place's LLM-configuration delegate.
//
...
//
// The able here is mostly a stub so the @llm-assigner stance resolves
// and the being row carries the able grant. triggerOn: [] means
...
export const llmAssignerAble = Object.freeze({
  name: "llm-assigner",
  description:
