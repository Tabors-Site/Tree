...
// NOTE on the name: the able is "mongo-connection" while the BEING
// is named "mongo". The ables mirror manifests every registered able
// as a space named after it under ./ables, and matter/space names
// are unique per kind per history — a able named "mongo" would
// collide with the ./host/mongo space.
export const mongoAble = Object.freeze({
