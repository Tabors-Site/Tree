...
router.get(
  ...
  async (req, res) => {
    try {
      ...
      return res.send(renderUnderstandingRun({
        run,
        qs,
        nodes,
        completed,
...
router.get(
  ...
  async (req, res) => {
    try {
      ...
      return res.send(renderUnderstandingNode({
        data,
        nodeId,
        qs,
        encodingHistory,
...
router.get("/root/:nodeId/understandings", urlAuth, async (req, res) => {
  try {
    ...
    return res.send(renderUnderstandingsList({
      data,
      nodeId,
      queryString,
      runCards,
...
router.get(
  ...
  async (req, res) => {
    try {
      ...
      return res.send(renderRunNodeView({
        data,
        nodeId,
        runId,
        qs,
