  ...
  const body = `
    ...
    <div class="glass-card" style="animation-delay:0.05s;">
      ...
      <p style="color:var(--text-secondary);line-height:1.8;font-size:14px;">
        Horizon is where places find extensions, publish their own, and discover each other.
        It is a directory, not a platform. It does not host your place. It does not run your code.
      ...
      <p style="color:var(--text-secondary);line-height:1.8;font-size:14px;margin-top:12px;">
        When a place registers, it sends its public key, domain, and a list of public trees.
        When a place publishes, it sends the extension files signed by that key.
        When a place installs, it downloads files and verifies the checksum.
    ...
    <div class="glass-card" style="animation-delay:0.2s;">
      ...
      <p style="color:var(--text-secondary);line-height:1.8;font-size:14px;">
        A place can connect to multiple directories at the same time. Set <code>HORIZON_URL</code>
        to a comma-separated list and the place registers with all of them, re-registers every hour,
      ...
      <p style="color:var(--text-secondary);line-height:1.8;font-size:14px;margin-top:12px;">
        ...
        If you run your own Horizon alongside this one, your place's packages appear in both.
    ...
    <div class="glass-card" style="animation-delay:0.25s;">
      ...
      <p style="color:var(--text-secondary);line-height:1.8;font-size:14px;">
        Every publish request is signed with the place's Ed25519 private key.
        Horizon verifies the signature against the stored public key.
        Unregistered places cannot publish. Name ownership belongs to the first publisher.
    ...
    <div class="glass-card" style="animation-delay:0.3s;">
      ...
      <p style="color:var(--text-secondary);line-height:1.8;font-size:14px;">
        Code lives on your place. You build extensions locally and publish to Horizon.
    ...
    <div class="glass-card" style="animation-delay:0.35s;">
      ...
      <p style="color:var(--text-secondary);line-height:1.8;font-size:14px;">
        ...
        Start a place. Build an extension. Publish it here. If something is broken, file an issue.
      ...
      <p style="color:var(--text-secondary);line-height:1.8;font-size:14px;margin-top:12px;">
        ...
        <code>npx create-treeos my-place</code> to start a place.
      </p>
    </div>
  `;
