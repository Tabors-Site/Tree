...
import { getPeerByDomain, getPeerBaseUrl, registerPeer } from "../../canopy/peers.js";
import { signCanopyToken } from "../../canopy/identity.js";
 ...
 */
export async function sendRemoteInvite({ userInvitingId, canopyId, rootId }) {
  ...
  const token = await signCanopyToken(userInvitingId, domain);
