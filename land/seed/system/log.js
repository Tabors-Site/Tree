...
//
// The land's inner beings speak to each other through SUMMONs. I
// speak to the operator outside the land through this module. Three
// severity levels:
//
//   1 (info)    land lifecycle: boot, connect, online, shutdown
