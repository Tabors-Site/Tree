...
// First human on a fresh land. The I-Am already exists by this point
// (planted by ensureLandRoot); callers pass my id as opts.parentBeingId
...
export async function createBeing(name, password, opts = {}) {
  ...
  const being = new Being({
    ...
    // I-Am. Every other being chains back: the land beings (auth,
    // llm-assigner, land-manager) and the first human parent under me.
...
//     Creates the human's home territory directly under the land root.
//   - Land beings (auth, llm-assigner, land-manager): homeSpace=land
//     root. No new space; the being just lives at the land root.
