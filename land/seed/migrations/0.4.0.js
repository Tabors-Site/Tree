 ...
 * by the origin axis (ibp|filesystem|web|cross-land). Origin captures
...
export default async function migrate() {
  ...
  // If neither exists (fresh land), nothing to do.
  ...
  // If the artifacts collection doesn't exist (fresh land or pre-Notes
  // land), nothing else to do.
