...
// live at one. Matter sits in one. Dids target one. Summons land
// at one. The whole world reduces to a tree of Spaces with things
// hanging off the branches.
//
// I plant the land root at boot; everything else descends from it.
// Being-created spaces fill out the tree underneath; the nine land
...
const SpaceSchema = new mongoose.Schema({
  ...
  // values are in seed/land/space/seedSpaces.js.
  seedSpace: {
    type: String,
...
// (see seed/land/space/spaceManagement.js). I never hard-delete.
