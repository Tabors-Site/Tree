...
//
// I am model-agnostic. Every land brings its own LLMs and every
...
// seed/cognition/llmClient.js walks space-tree → being → land to
...
// land's `allowedLlmDomains` list bypass the private-IP block — the
// explicit opt-in for LAN-hosted LLMs. `maxConnectionsPerUser` (land
