...
const ContributionSchema = new mongoose.Schema({
  ...
  aiChatId: { type: String, ref: "AIChat" },
  ...
  editNameNode: { type: { oldName: String, newName: String, _id: false } },
  ...
  updateChildNode: { type: { action: { type: String, enum: ["added", "removed"] }, childId: { type: String, ref: "Node" }, _id: false } },
