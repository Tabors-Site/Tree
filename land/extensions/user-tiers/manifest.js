export default {
  ...
  description:
    ...
    "during init. The hasAccess(beingId, feature) export checks the user's current tier " +
    ...
    "set any user's tier via PUT /user/:beingId/tier. The CLI exposes 'tier' to check " +
  ...
  provides: {
    ...
    sessionTypes: {},
    cli: [
      { command: "tier", scope: ["home"], description: "Show your current tier", method: "GET", endpoint: "/user/:beingId/tier" },
    ],
  },
};
