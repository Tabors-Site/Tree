// TreeOS default MCP tool definitions. Modes reference these by name.
  ...
  "edit-node-or-branch-status": {
    ...
    function: {
      ...
      parameters: {
        ...
        required: ["nodeId", "status", "isInherited", "beingId"],
      },
    },
  },
  ...
  "create-node-note": {
    ...
    function: {
      ...
      parameters: {
        ...
        required: ["content", "nodeId", "beingId"],
      },
    },
  },
  "edit-node-note" : {
  ...
  "create-new-node": {
    ...
    function: {
      ...
      parameters: {
        ...
        required: ["name", "parentId", "beingId"],
      },
    },
  },
  ...
  "create-new-node-branch": {
    ...
    function: {
      ...
      parameters: {
        ...
        required: ["nodeData", "parentId", "beingId"],
      },
    },
  },
  "delete-node-branch": {
  ...
  "edit-node-name": {
    ...
    function: {
      ...
      parameters: {
        ...
        required: ["nodeId", "newName", "beingId"],
      },
    },
  },
  ...
  "edit-node-type": {
    ...
    function: {
      ...
      parameters: {
        ...
        required: ["nodeId", "newType", "beingId"],
      },
    },
  },
  ...
  "update-node-branch-parent-relationship": {
    ...
    function: {
      ...
      parameters: {
        ...
        required: ["nodeChildId", "nodeNewParentId", "beingId"],
      },
    },
  },
  ...
  "transfer-raw-idea-to-note": {
    ...
    function: {
      ...
      parameters: {
        ...
        required: ["rawIdeaId", "nodeId", "beingId"],
      },
    },
  },
