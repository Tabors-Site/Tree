...
export function renderKbDashboard({ rootId, rootName, status, stale, unplaced, token, beingId, hasEmbed, hasScout, inApp }) {
  if (!status) {
  ...
  return renderAppDashboard({
    rootId, rootName: status.name || rootName, token, beingId, inApp,
