...
const { subscribe, emitToSubscribers, _resetAll: resetSubscriptions } = await import("../ibp/subscriptions.js");
const { attachHandoff, _resetAll: resetScheduler } = await import("../ibp/scheduler.js");
