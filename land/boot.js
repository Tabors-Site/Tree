...
# Land Identity
LAND_DOMAIN=${values.LAND_DOMAIN}
...
# Default tier for new users (god = unlimited for self-hosted)
LAND_DEFAULT_TIER=${values.LAND_DEFAULT_TIER}

# Server-rendered HTML pages
ENABLE_FRONTEND_HTML=${values.ENABLE_FRONTEND_HTML}

# Canopy directory (leave empty for standalone)
DIRECTORY_URL=${values.DIRECTORY_URL}

# Encryption key for stored LLM connections
