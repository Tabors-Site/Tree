// store/roles/publisher — the public publisher role piece.
//
...
// curated store is one config on this role (self-grantable vs
...
export default {
  ...
  version: "0.1.0",
  description:
    "The public role a being takes to publish to the store catalog. The publisher's key signs the listing; the registrar trusts the signature.",
  requires: [],
};
