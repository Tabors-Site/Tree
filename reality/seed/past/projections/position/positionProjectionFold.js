...
async function handleSetBeingCoord(fact /*, type, id*/) {
  ...
  const { loadOrFold, assertBranchOrThrow } = await import("../../../materials/projections.js");
  const branch = assertBranchOrThrow(fact.branch, "positionProjectionFold(set-coord)");
