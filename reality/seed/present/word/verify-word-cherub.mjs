...
const realityRoot = path.resolve(__dirname, "../../.."); // .../reality
...
process.env.MONGODB_URI = "mongodb://localhost:27017/reality-word-cherub-test";
...
if (mongoose.connection.name !== "reality-word-cherub-test") {
