...
const REQUIRED_INDEXES = [
  ...
  { collection: "spaces", fields: { owner: 1, createdAt: -1 } },
 ...
 * materials/being/, Fact in past/fact/, etc.), or the default
 * Mongoose pluralization where the third arg is omitted.
 */
...
export async function ensureIndexes() {
  ...
  await Promise.all([
    ...
    import("../materials/history/history.js"),
    import("../materials/history/projection.js"),
