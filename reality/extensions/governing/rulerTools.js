...
//   it finishes, it replies via emitReplyToAsker which places in
  ...
  return [
    ...
    // ─────────────────────────────────────────────────────────────────
    {
      ...
      async handler(args) {
        ...
        const stancePath = `${realityDomain}/${ruler._id}`;
    ...
    // ─────────────────────────────────────────────────────────────────
    {
      ...
      async handler(args) {
        ...
        const { getRealityDomain } = await import("../../seed/ibp/address.js");
        const realityDomain = getRealityDomain();
        const rulerStance = `${realityDomain}/${ruler._id}@${rulerUsername}`;
    ...
    // ─────────────────────────────────────────────────────────────────
    {
      ...
      description:
        ...
        "returns 'spawned' immediately. The Foreman's reply places in " +
    ...
    // 2 court reasoning places later.
    // ─────────────────────────────────────────────────────────────────
    {
      ...
      async handler(args) {
        ...
        return text(JSON.stringify({
          ...
          message:
            ...
            "places later). The orchestrator will surface this above the scope.",
        }));
      },
    },
  ];
