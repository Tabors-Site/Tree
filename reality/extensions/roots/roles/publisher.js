// roots:publisher. The public role a being picks up to publish.
//
...
// key is PRESENT to the roots is orthogonal to the role:
//
...
//     stance, acting on the roots over cross-reality IBP with its full
...
//
// An open roots makes this role self-grantable (any identified being
// may take it); a curated roots gates the grant behind operator review.
...
export const publisherRole = Object.freeze({
  name: "roots:publisher",
  description:
    "Lets a being publish to this roots's catalog. Hold it, then summon @registrar with intent publish-listing or retire-listing. Listings attribute to the holder's key.",
  ...
  // the summon envelope.
  canSummon: [
    { pattern: "@registrar", description: "Summon the roots registrar to publish or retire a listing." },
  ],

  canBe: [],

  label: "Roots Publisher",
});
