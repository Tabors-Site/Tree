...
// seed plants its own place root and heaven spaces inside itself
...
async function pickExtensions() {
  ...
  if (peeringExt) {
    ...
    console.log("    Lets this story be findable on the network and find others.");
    console.log("    The substrate's wire (cross-story SUMMONs, GRAFTs) works regardless;");
  ...
  if (storeExt) {
    ...
    console.log("    Lets this story publish a catalog of resources others can draw.");
