...
import { getToolOwner, isExtensionBlockedAtSpace, isToolReadOnly } from "../../seed/place/space/extensionScope.js";
...
async function handleMcpRequest(req, res) {
  try {
    ...
    if (method === "tools/call") {
      ...
      if (req.beingId) {
        try {
          const { getCurrentSpace, getSpaceRootId } = await import("../../seed/place/being/position.js");
