...
const PlacePeerSchema = new mongoose.Schema({
...
PlacePeerSchema.index({ status: 1 });

const PlacePeer = mongoose.model("PlacePeer", PlacePeerSchema);

export default PlacePeer;
