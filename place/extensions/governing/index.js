...
export async function init(core) {
  ...
  if (core?.hooks?.register) {
    ...
    // 30-60 seconds on places with hundreds of governing nodes; the 5s hook
  ...
  return {
    ...
    exports: {
      ...
      // surface places in Pass 2; Pass 1 establishes the data home.
      ...
      // installed at all (governing-alone place).
      shouldGovernAtScope,
