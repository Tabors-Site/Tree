...
function matterMaxChars()    { return Math.max(100, Number(getPlaceConfigValue("matterMaxChars"))    || 5000); }
function maxMatterPerSpace() { return Math.max(1,   Number(getPlaceConfigValue("maxMatterPerSpace")) || 1000); }
function matterQueryLimit()  { return Math.max(1,   Math.min(Number(getPlaceConfigValue("matterQueryLimit"))  || 5000, 50000)); }
function searchQueryLimit()  { return Math.max(1,   Math.min(Number(getPlaceConfigValue("matterSearchLimit")) || 500, 10000)); }
