...
//
// The place's inner beings speak to each other through SUMMONs. I
// speak to the operator outside the place through this module. Three
// severity levels:
//
//   1 (info)    place lifecycle: boot, connect, online, shutdown
