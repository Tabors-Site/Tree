 ...
 *
 * `citizen` (read-only browsing of the place's public surface) was
 * listed in PLACE_BEINGS but never had a role template registered.
 ...
 * `qualities.beings.citizen` entry from the place root. Idempotent.
 */
