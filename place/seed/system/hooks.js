...
function HOOK_TIMEOUT_MS() { return Number(getPlaceConfigValue("hookTimeoutMs")) || 5000; }
function MAX_HANDLERS_PER_HOOK() { return Number(getPlaceConfigValue("hookMaxHandlers")) || 100; }
function CIRCUIT_BREAKER_THRESHOLD() { return Number(getPlaceConfigValue("hookCircuitThreshold")) || 5; }
function CIRCUIT_HALF_OPEN_MS() { return Number(getPlaceConfigValue("hookCircuitHalfOpenMs")) || 300000; }
function CHAIN_TIMEOUT_MS() { return Number(getPlaceConfigValue("hookChainTimeoutMs")) || 15000; }
