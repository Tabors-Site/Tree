...
// I_AM (`<place>/<placeRoot>@I_AM`). The subscriber declared a
// cadence; the I_AM holds the declaration and emits the SUMMON when
// the tick fires. Places that want an embodied scheduler-being install
...
// place later if a real subscription needs them. For now: simple intervals,
