...
pub struct Planted {
    ...
    /// The I-name used (default `"i-am"`, or `"I"` under the rename). Surfaced so
    /// the caller can see which side of the fork this Story was planted on.
    pub i_name: String,
...
/// I-name (self-stamping: i-am declares its own name). of:{kind:"library",
