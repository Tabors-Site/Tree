...
import express from "./protocols/transports/http/app.js";
import cors from "./protocols/transports/http/middleware/cors.js";
import http from "http";
import fs from "fs";
import path from "path";
import { fileURLToPath } from "url";
import cookieParser from "./protocols/transports/http/middleware/cookies.js";

import registerRoutes from "./protocols/transports/http/handler.js";
import { initWebSocketServer } from "./protocols/transports/ws/websocket.js";
...
import securityHeaders from "./protocols/transports/http/middleware/securityHeaders.js";
...
function corsOriginCheck(origin, cb) {
  ...
  // Chrome extensions (parity with the WS CORS in protocols/transports/ws/websocket.js).
...
// (protocols/transports/ws/websocket.js) honors the COOKIE token only when the
...
let mirrorProc = null;
try {
  const scriptPath = path.join(__dirname, "seed", "seedStory", "mirror-mount.mjs");
