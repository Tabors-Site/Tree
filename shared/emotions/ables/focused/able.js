// emotions:focused — modifier able spec.
//
...
export const focusedAble = Object.freeze({
  name: "focused",
  description: `Modifier able: stacks onto a primary able to shape voice as "focused".`,
  can: [],
